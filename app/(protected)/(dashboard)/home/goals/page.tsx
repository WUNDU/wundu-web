    ...
    <div className="w-full max-w-[1360px] mx-auto flex flex-col gap-3">
      ...
      >
        ...
        <motion.button
          ...
          className="flex items-center gap-1.5 bg-[#003cc3] text-white text-xs font-bold px-3 sm:px-4 py-2.5 rounded-full shadow-sm hover:bg-[#0033a8] transition-colors"
        >
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-bold text-[#1e293b]">Em andamento</h3>
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-12 gap-3 bg-white rounded-[20px] shadow-[0_4px_16px_rgba(0,60,195,0.06)]">
      ...
      {completed.length > 0 && (
        ...
        >
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-[#1e293b]">Concluídos</h3>
            <span className="text-xs text-[#94a3b8]">
