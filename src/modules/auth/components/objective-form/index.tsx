import { TextInput, Button, Select } from "@/shared/components";
import { useObjectiveForm } from "@/hooks/objective/use-objective-form";
...
const ObjectiveForm: React.FC<ObjectiveFormProps> = ({ onSuccess }) => {
  const { form, setField, save, status, errorMessage } = useObjectiveForm({
    onSuccess,
  });
  const {
    categories,
