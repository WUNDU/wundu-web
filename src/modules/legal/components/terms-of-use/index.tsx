import { DocumentIcon, EditIcon, InfoIcon } from "@/constants/icons";
import { LegalSection } from "@/shared/components";
import {
  CopyrightIcon,
  GavelIcon,
  RocketIcon,
      ...
      <LegalSection icon={<GavelIcon />} title="7. Lei Aplicável" delay={700}>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <li>
            ...
            incluindo consentimento, acesso, retificação, apagamento e
            portabilidade
          </li>
          <li>
