...
import { BottomNavigation, Button, GreetingHeader, TextInput } from "@/shared/components";
...
const SupportScreen: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-linear-to-br from-slate-50 via-white to-blue-50/30 relative overflow-hidden font-sans antialiased text-gray-800">
