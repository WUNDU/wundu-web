            ...
            >
              <div className="flex items-start space-x-6 p-6 rounded-2xl hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div className="shrink-0">
                  <div
                    className={`w-16 h-16 bg-linear-to-br ${feature.color} rounded-2xl flex items-center justify-center text-2xl text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                    {feature.icon}
                  </div>
                </div>
                <div className="flex-1">
                  ...
                  <ul className="space-y-2">
                    {feature.items.map((item, itemIndex) => (
                      ...
                      >
                        <span
                          className={`w-2 h-2 bg-linear-to-r ${feature.color} rounded-full mr-3`}
                        ></span>
                        {item}
                      </li>
                    ))}
