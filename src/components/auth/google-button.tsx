...
/**
 * Botão "Continuar com Google". Inicia o OAuth via NextAuth e devolve ao
 * /google-callback, que troca o idToken por uma sessão Wundu (login ou,
 * para contas novas, encaminha para o registo Google).
 */
