  ...
  return (
    <div className="space-y-8">
      ...
      <LegalSection icon="⚙️" title="2. Como usamos cookies" delay={200}>
        ...
        <p className="mb-6">
          Necessários para o funcionamento do site. Incluem, por exemplo, cookies que permitem que você faça login
          em áreas seguras do site.
        </p>

        <h3 className="text-xl font-semibold text-gray-900 mb-3">2.2. Cookies de desempenho:</h3>
        <p className="mb-6">
          Coletam informações sobre como os visitantes usam nosso site, quais páginas visitam e se encontram erros.
          Esses cookies não coletam informações que identificam um visitante e são usados apenas para melhorar o
          funcionamento do site.
        </p>

        <h3 className="text-xl font-semibold text-gray-900 mb-3">2.3. Cookies de funcionalidade:</h3>
        <p className="mb-6">
          Permitem que o site lembre de escolhas que você faz (como seu nome de usuário, idioma ou região) e
          forneçam recursos aprimorados e mais personalizados.
        </p>

        <h3 className="text-xl font-semibold text-gray-900 mb-3">2.4. Cookies de publicidade/direcionamento:</h3>
        <p>
          Registram suas visitas ao nosso site, as páginas que você visitou e os links que você seguiu. Usamos essas
          informações para tornar nossa publicidade mais relevante para seus interesses.
        </p>
      </LegalSection>
      ...
      <LegalSection icon="🎛️" title="3. Controle de cookies" delay={300}>
        <p className="mb-4">
          ...
          no seu dispositivo e pode configurar a maioria dos navegadores para impedir que sejam colocados. No
          entanto, se você fizer isso, talvez tenha que ajustar manualmente algumas preferências sempre que visitar
      ...
      <LegalSection icon="🔌" title="4. Cookies de terceiros" delay={400}>
        <p className="mb-4">
          Alguns cookies são colocados por serviços de terceiros que aparecem em nossas páginas. Utilizamos serviços
          de terceiros como:
        </p>
        ...
        <p>
          Esses terceiros podem coletar suas informações pessoais quando você interage com seus serviços.
          Recomendamos que você consulte as políticas de privacidade desses terceiros para entender como eles usam
          suas informações.
        </p>
      </LegalSection>
    </div>
