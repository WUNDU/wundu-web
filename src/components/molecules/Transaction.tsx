...
export const Transaction: React.FC<TransactionProps> = ({ icon, title, transactions, amount, percentage }) => {
  return (
    <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm my-2">
      <div className="flex items-center space-x-4">
        <Icon initials={icon.initials} bgColor={icon.bgColor} color={icon.color} />
        <div>
      ...
      <div className="text-right">
        <p className={`font-semibold ${amount < 0 ? 'text-red-500' : 'text-green-500'}`}>
