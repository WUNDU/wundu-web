const backArrow = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M12.7496 9.91683C12.7496 9.91683 5.66636 15.1336 5.66636 17.0002C5.66636 18.8668 12.7497 24.0835 12.7497 24.0835" stroke="#141B34" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
