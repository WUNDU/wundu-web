...
const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center md:bg-gray-100 md:p-4 font-sans">
      ...
      <div className="flex w-full md:max-w-4xl flex-col items-center md:rounded-3xl md:bg-white md:shadow-2xl md:flex-row md:overflow-hidden md:p-0">
      ...
      <div className="mt-4  md:mt-8 w-full max-w-xl text-center md:absolute md:bottom-8 md:left-1/2 md:-translate-x-1/2">
        <p className="mt-1 p-1 text-center text-xs text-gray-500">
