...
function PrivacyPolicyPage() {
  return (
    <LegalTemplate
      ...
      subtitle="WUNDU • Privacidade e Segurança em Primeiro Lugar"
      description="Entenda como coletamos, usamos e protegemos suas informações pessoais e financeiras enquanto você utiliza os serviços da WUNDU."
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">

        <LegalSection icon="🛡️" title="1. Introdução" delay={100}>
          <p>
            A WUNDU está empenhada em proteger sua privacidade e garantir a segurança dos seus dados pessoais. Esta
            Política de Privacidade explica como coletamos, usamos, compartilhamos e protegemos suas informações quando você
            utiliza nosso aplicativo de controle financeiro, visita nosso site ou interage com nossos serviços, comunicações e
            anúncios. Ao usar nossos serviços, você concorda com esta política.
          </p>
        </LegalSection>
        ...
        <LegalSection icon="📊" title="2. Informações que coletamos" delay={200}>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-3">2.3. Dados sensíveis:</h3>
          <p>
            Podemos processar dados financeiros, que são considerados sensíveis. Esses dados são
            protegidos com medidas de segurança reforçadas e processados apenas com seu consentimento explícito ou
            conforme necessário para cumprir obrigações contratuais.
          </p>
        </LegalSection>

        <LegalSection icon="⚙️" title="3. Como usamos suas informações" delay={300}>
          <p className="mb-4">Utilizamos suas informações com base nas seguintes bases legais:</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <LegalSection icon="🔗" title="4. Compartilhamento de informações" delay={400}>
          <p className="mb-4">
          ...
          <p>
            Se seus dados forem transferidos para fora de Angola, garantimos que o país de destino tenha proteção
            adequada ou que salvaguardas apropriadas estejam em vigor, conforme exigido pelos Artigos 51-54 da Lei de Proteção de Dados.
          </p>
        </LegalSection>
        ...
        <LegalSection icon="🔒" title="5. Segurança dos dados" delay={500}>
          ...
          <p>
            Em caso de violação de dados, avaliaremos a natureza e o escopo da violação. Notificaremos a Agência de
            Proteção de Dados (APD) em até 72 horas e informaremos os usuários afetados se houver risco significativo aos seus direitos e liberdades.
          </p>
        </LegalSection>
        ...
        <LegalSection icon="👤" title="6. Seus direitos" delay={600}>
          ...
          <p>
            ...
            <a href="mailto:Support@wundu.tech" className="text-blue-600 hover:text-blue-800 font-medium">
              Support@wundu.tech
            </a>. Você também pode registrar reclamações junto à Agência de Proteção de Dados (APD) de Angola.
          </p>
        </LegalSection>
        ...
        <LegalSection icon="📝" title="8. Alterações nesta política" delay={800}>
          <p className="mb-4">
            ...
            materiais através do nosso aplicativo ou site.
          </p>
