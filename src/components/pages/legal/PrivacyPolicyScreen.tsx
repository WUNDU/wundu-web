      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <li>
              <strong>Interesses legítimos</strong>: Quando necessário para
              nossos interesses ou de terceiros, salvo se seus direitos
              prevalecerem
            </li>
          </ul>
        ...
        >
          ...
          <p>
            Se seus dados forem transferidos para fora de Angola, garantimos que
            o país de destino tenha proteção adequada ou que salvaguardas
            apropriadas estejam em vigor, conforme exigido pelos Artigos 51-54
        ...
        <LegalSection icon="🔒" title="5. Segurança dos dados" delay={500}>
          ...
          <p>
            ...
            violação. Notificaremos a Agência de Proteção de Dados (APD) em até
            72 horas e informaremos os usuários afetados se houver risco
        ...
        <LegalSection icon="⏰" title="7. Retenção de dados" delay={700}>
          <p>
            ...
            período de retenção mais longo seja exigido por lei.
          </p>
        </LegalSection>
