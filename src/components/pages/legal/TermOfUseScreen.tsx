...
function TermsOfUsePage() {
  return (
    <LegalTemplate
      title="Termos de Uso"
      subtitle="WUNDU • Termos e Condições"
      description="Conheça os termos e condições que regem o uso dos nossos serviços e aplicativo WUNDU."
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <LegalSection icon="📄" title="1. Aceitação dos Termos" delay={100}>
          <p>
            Ao acessar e utilizar o aplicativo e serviços da WUNDU, você
            concorda com estes Termos de Uso e com nossa Política de
            Privacidade. Se você não concordar com algum aspecto desses termos,
        ...
        <LegalSection icon="🚀" title="2. Uso do Serviço" delay={200}>
          <p className="mb-4">
            A WUNDU oferece um aplicativo de gerenciamento financeiro pessoal
            que permite aos usuários rastrear gastos, criar orçamentos e
            estabelecer metas financeiras. Ao utilizar nosso serviço, você
            concorda em:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Não tentar acessar áreas restritas do serviço sem autorização
            </li>
          </ul>
        </LegalSection>
        ...
        <LegalSection icon="💾" title="3. Conteúdo do Usuário" delay={300}>
          <p>
            ...
            WUNDU. Ao fornecer seu conteúdo em nosso serviço, você concede à
            WUNDU uma licença mundial, não exclusiva e isenta de royalties para
            usar, modificar, executar e exibir esse conteúdo em conexão com a
            operação do serviço.
          </p>
        </LegalSection>
        ...
        <LegalSection icon="©️" title="4. Propriedade Intelectual" delay={400}>
          <p>
            ...
            incluindo, mas não se limitando a textos, gráficos, logotipos,
            ícones, imagens, clipes de áudio, downloads digitais e compilações
            de dados, são propriedade da WUNDU ou de seus licenciadores e
        ...
        <LegalSection icon="⚖️" title="7. Lei Aplicável" delay={700}>
          <p className="mb-4">
            ...
            leis da República de Angola. Especificamente, o processamento de
            dados pessoais no âmbito do uso dos serviços da WUNDU está sujeito à
            Lei de Proteção de Dados Pessoais, conforme proposta de revisão,
            incluindo, mas não se limitando aos seguintes artigos:
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>Artigos 6 a 13</strong> – Princípios de licitude,
              minimização, transparência, finalidade, exatidão, conservação,
              integridade e confidencialidade dos dados
            </li>
            <li>
              <strong>Artigos 14 a 23</strong> – Direitos dos titulares dos
              dados, incluindo consentimento, acesso, retificação, apagamento e
              portabilidade
            </li>
            <li>
              <strong>Artigos 26 a 35</strong> – Segurança dos dados, medidas de
              proteção, avaliação de impacto e notificação de violações de dados
            </li>
            <li>
              <strong>Artigos 39 a 42</strong> – Proteção de dados desde a
              concepção, segurança dos dados e dever de notificação de violações
            </li>
            <li>
              <strong>Artigos 51 a 54</strong> – Transferências internacionais
              de dados, incluindo requisitos de adequação e garantias
              apropriadas
            </li>
          </ul>
          ...
          <p className="mt-4">
            ...
            jurisdição dos tribunais competentes em Angola.
          </p>
        </LegalSection>
      </div>
    </LegalTemplate>
