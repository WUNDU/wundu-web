...
const CategoryScreen = ({ onCloseOrSuccess }: CategoryScreenProps) => {
  ...
  const handleSave = () => {
    if (selectedCategory && transactionDescription.trim()) {
      try {
        ...
        // Close success modal, category screen, and details modal after 2 seconds
        setTimeout(() => {
          setShowSuccessModal(false);
          setIsCategoryModalOpen(false);
          onCloseDetailsModal(); // Close DetailsModal
          setSelectedCategory(null);
          setTransactionDescription('');
          onCloseOrSuccess?.(); // Fechar o layout side-by-side
          console.log('Success modal closed, returning to home');
        }, 2000);
      } catch (error) {
  ...
  const handleClose = () => {
    ...
    setSelectedCategory(null);
    setTransactionDescription('');
    onCloseOrSuccess?.(); // Fechar o layout side-by-side ao fechar sem salvar
  };
  ...
  return (
    <>
        ...
        <div className="min-h-screen bg-gray-50">
          ...
          <div className="p-6 bg-gray-100 rounded-2xl">
            <div className='bg-white rounded-2xl p-4'>
              ...
              {selectedCategory && (
                <div className="mb-8">
                  <h3 className="text-base font-medium text-gray-700 mb-4">Descrição</h3>
                  <textarea
              ...
              {/* Botão Guardar aparece abaixo do form quando há texto */}
      ...
      <div className="hidden md:block mt-2 w-full h-full overflow-y-auto">
        {/* Header */}
        <div className="md:hidden flex items-center justify-between p-6 bg-gray-100 border-b border-gray-100">
          <button
            onClick={handleClose}
            className="p-2 -m-2 hover:bg-gray-100 rounded-full transition-colors"
          >
