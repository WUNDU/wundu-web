...
import FinancialObjectiveCard from "@/ui/molecules/financial-objective-card";
...
import SketchPanel from "@/ui/molecules/sketch-panel";
      ...
      >
        ...
        <main className="p-4 pb-28 md:pb-6 space-y-6 flex-1 min-h-0 animate-slide-up">
          <div className="flex flex-col flex-1 min-h-0 rounded-2xl p-5 space-y-10">
            ...
            <div
              className="hidden md:flex mt-8 md:mt-0 rounded-2xl h-full min-h-[520px] p-2 pb-6 md:min-w-full animate-slide-up"
