...
import ChatOptions from "@/ui/molecules/ChatOption";
import ChatMessages from "@/ui/molecules/ChatMessage";
import { NavigationBack } from "@/ui/atoms";
import InitialInputArea from "@/ui/molecules/InitializeInputArea";
...
const ChatScreen: React.FC = () => {
  const { showChat, setShowChat, isSidebarOpen, isSidebarRightOpen, toggleSidebarRight, prev } =
    useChatScreen();
