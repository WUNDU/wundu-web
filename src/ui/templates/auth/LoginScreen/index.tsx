...
const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white md:bg-gradient-to-br md:from-slate-50 md:via-slate-200 md:to-slate-300">
      {/* Floating Elements - apenas desktop */}
      <div className="hidden md:block absolute top-20 left-10 w-24 h-24 rounded-full blur-xl animate-float opacity-30" style={{ backgroundColor: 'rgba(255, 212, 0, 0.3)' }}></div>
          ...
          <div className="flex w-full flex-col lg:flex-row">
            ...
            <div className="hidden lg:flex flex-1 items-center justify-center p-8 lg:w-1/2 lg:p-14 fade-in-section animate-in delay-3">
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-blue-400/20 to-yellow-400/20 rounded-full blur-3xl -z-10 animate-pulse-slow"></div>
              </div>
            </div>
