...
const PageHero: React.FC<PageHeroProps> = ({
  ...
  return (
    <section 
      ...
      style={{
        background: 'linear-gradient(135deg, #00216b 0%, #003cc3 50%, #003cc3 100%)'
      }}
    >
      ...
      <div className="absolute top-20 left-20 w-32 h-32 rounded-full blur-xl animate-float transform-gpu" style={{ backgroundColor: 'rgba(255, 212, 0, 0.2)' }}></div>
      <div className="absolute bottom-20 right-20 w-24 h-24 rounded-full blur-lg animate-float-delayed transform-gpu" style={{ backgroundColor: 'rgba(202, 111, 5, 0.3)' }}></div>
      <div className="absolute top-1/2 left-10 w-16 h-16 bg-white/10 rounded-full blur-md animate-bounce-soft"></div>
      <div className="absolute top-1/3 right-10 w-20 h-20 rounded-full blur-lg animate-float" style={{ backgroundColor: 'rgba(255, 212, 0, 0.15)' }}></div>
      ...
      <div className={`max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 ${centered ? 'text-center' : ''} relative z-10`}>
