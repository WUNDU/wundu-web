...
import { CheckmarkIcon, MoneyBagIcon, ChartIcon, GoalsIcon } from "@/constants/icons";
    ...
    <div className="flex m-4 flex-col h-full justify-center items-center text-center p-8 md:p-0 md:gap-6 relative overflow-hidden">
      ...
      <div className={`relative transition-all duration-1000 ease-out transform ${
        ...
        <div className="w-24 h-24 mb-8 md:mb-4 flex items-center justify-center rounded-full bg-gradient-to-br from-green-100 to-green-200 shadow-lg relative">
          {/* Pulse Rings */}
          <div className={`absolute inset-0 rounded-full bg-green-200 ${
          ...
          <CheckmarkIcon className={`w-16 h-16 text-green-600 relative z-10 transition-all duration-700 ease-out transform ${
            isVisible ? 'scale-100 rotate-0 translate-y-1' : 'scale-0 rotate-180 translate-y-1'
          }`} style={{ transitionDelay: '0.3s' }} />
        </div>
      </div>

      {/* Title with Slide Up Animation */}
      <h1 className={`text-3xl md:text-2xl font-bold text-gray-800 transition-all duration-800 ease-out ${
      ...
      <p className={`mt-2 text-gray-600 max-w-sm mx-auto transition-all duration-800 ease-out ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
      ...
      <div className={`fixed bottom-0 left-0 right-0 p-4 md:static md:p-0 md:w-full md:max-w-sm transition-all duration-800 ease-out ${
