const Profile = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        d="M3.66666 16.5007C3.66666 15.5282 4.05296 14.5956 4.7406 13.9079C5.42823 13.2203 6.36086 12.834 7.33332 12.834H14.6667C15.6391 12.834 16.5717 13.2203 17.2594 13.9079C17.947 14.5956 18.3333 15.5282 18.3333 16.5007"
        stroke="currentColor"
        strokeOpacity="0.8"
        strokeWidth="2"
        strokeLinecap="round"
