        ...
        <div className="animate-pulse">
          ...
          <div className="flex space-x-4">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="bg-gray-200 rounded-lg p-4 w-20 h-24"
              ></div>
            ))}
          </div>
        </div>
    ...
    <div className="flex flex-col items-center space-y-8 p-8">
      ...
      <div className="flex flex-wrap justify-center gap-4 md:gap-6">
        {timeUnits.map((unit, index) => (
          ...
          >
            <div
              className={`bg-gradient-to-br ${unit.color} text-white rounded-2xl shadow-lg p-4 md:p-6 min-w-[80px] md:min-w-[100px] transform hover:scale-105 transition-transform duration-200`}
            >
              <div className="text-center">
