        ...
        {timeUnits.map((unit, index) => (
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #00216b 0%, #003cc3 50%, #ffd400 100%)",
              }}
            >
              ...
              <div
                className="absolute top-1 right-1 w-3 h-3 rounded-full blur-sm opacity-30"
                style={{ backgroundColor: "rgba(255, 212, 0, 0.6)" }}
              ></div>
              <div
                className="absolute bottom-1 left-1 w-2 h-2 rounded-full blur-sm opacity-20"
