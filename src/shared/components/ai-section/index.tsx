        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="fade-in-section">
            ...
            <p className="text-lg text-gray-600 mb-10 leading-relaxed">
              A nossa tecnologia avançada categoriza automaticamente as suas
              transações, identifica padrões de gastos e fornece insights
              personalizados para melhorar a sua saúde financeira.
            </p>
            <div className="space-y-6">
              {aiFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="flex items-start space-x-4 p-4 rounded-2xl hover:bg-yellow-50 transition-all duration-300"
                >
                  ...
                  <span className="text-gray-700 text-lg pt-2">
                    {feature.text}
                  </span>
                </div>
              ))}
